...
export class EstruturaPage {
    ...
    constructor(){
        ...
        this.dominioEstrutura[POSI_environmentalProblems] = {'dimensao':'socialAspectsForm','dominio':'environmentalProblemsForm','nomeDominio':'Problemas Ambientais','max_score':15,'campoScore':'score','campoInvestigar' : 'need_investigation','questaoInicio':72,'questaoFim': 87,'campoComentario' : 'comments', 'corTitulo': 'bg-warning', 'corLateral' : 'khaki'};
