  ...
  geraFormGroup(data?: CardiovascularFactors): FormGroup {
      if (data){
        this.cardiovascularFactorsForm = this.fb.group({
          ...
          q37_hypertension_unknow: [data.q37_hypertension_unknow,[Validators.required]],
          q38_uncontrolled_diabetes: [data.q38_uncontrolled_diabetes,[Validators.required]],
          q38_uncontrolled_diabetes_unknow: [data.q38_uncontrolled_diabetes_unknow,[Validators.required]],
          q39_cholesterol: [data.q39_cholesterol,[Validators.required]],
          q39_cholesterol_unknow: [data.q39_cholesterol_unknow,[Validators.required]],
          q40_smoker: [data.q40_smoker,[Validators.required]],
          q41_drink_type: [data.q41_drink_type,[Validators.required]],
          ...
          q42_practise_exercises_frequency: [data.q42_practise_exercises_frequency,[Validators.required]],
          q42_practise_exercises_time: [data.q42_practise_exercises_time,[Validators.required]],
      ...
      else 
      {
        this.cardiovascularFactorsForm = this.fb.group({
          ...
          q37_hypertension_unknow: ['',[Validators.required]],
          q38_uncontrolled_diabetes: ['',[Validators.required]],
          q38_uncontrolled_diabetes_unknow: ['',[Validators.required]],
          q39_cholesterol: ['',[Validators.required]],
          q39_cholesterol_unknow: ['',[Validators.required]],
          q40_smoker: ['',[Validators.required]],
          q41_drink_type: ['',[Validators.required]],
          ...
          q42_practise_exercises_frequency: ['',[Validators.required]],
          q42_practise_exercises_time: ['',[Validators.required]],
